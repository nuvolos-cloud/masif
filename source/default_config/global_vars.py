...
if "MSMS_BIN" in os.environ:
    ...
    logger.error("ERROR: MSMS_BIN not set. Variable should point to MSMS program.")
    sys.exit(1)
...
if "PDB2PQR_BIN" in os.environ:
    ...
    logger.error(
        "ERROR: PDB2PQR_BIN not set. Variable should point to PDB2PQR_BIN program."
    )
    sys.exit(1)
...
if "APBS_BIN" in os.environ:
    ...
    logger.error("ERROR: APBS_BIN not set. Variable should point to APBS program.")
    sys.exit(1)
...
if "MULTIVALUE_BIN" in os.environ:
    ...
    logger.error(
        "ERROR: MULTIVALUE_BIN not set. Variable should point to MULTIVALUE program."
    )
    sys.exit(1)
