...
precomp_dir = "/scratch/gainza/masif_precomputation/data_preparation/04b-precomputation_12A/precomputation"
...
neigh = np.load(
    os.path.join(precomp_dir, target_pdb_pair, "p1_geodists_indices.npy"),
    allow_pickle=True,
)[center_point]
print(neigh)
