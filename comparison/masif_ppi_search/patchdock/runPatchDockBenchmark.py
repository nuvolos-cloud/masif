...
for target_pdb in benchmark_pdbs_target:
    ...
    if target_pdb == "3RDZ_A_C" or target_pdb == "3S9C_A_B" or target_pdb == "3B5U_J_L":
    ...
    # For this PDB I had to manually select residue 8 as the target site (after manual inspection of the binding site)
    # , as no other was recognized by PatchDock as the target site.
    elif target_pdb == "2QLC_C_B":
        target_res_id = 8
